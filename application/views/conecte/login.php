                        ...
                        <div class="container">
                            <div class="card card-cad">
                                <div class="content">
                                    <div id="newlog">
                                        <div class="icon2">
                                            <img width="500px" height="500px" src="<?php echo base_url() ?>assets/img/logo-two.png">
                                        </div>
                                        <div class="title01">
                                            <img width="50px" height="50px" src="<?php echo base_url() ?>assets/img/logo-mapos-branco.png">
                                        </div>
                                    </div>
                                    ...
                                    <div class="links-uteis"><a href="https://github.com">
                                            <p><?= date('Y'); ?> &copy; LR Gerenciamentos</p>
                                        </a></div>
                                </div>
                            </div>
                        </div>
